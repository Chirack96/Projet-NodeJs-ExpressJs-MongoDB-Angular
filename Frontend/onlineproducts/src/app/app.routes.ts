...
export const appRoutes: Routes = [
        ...
        { path: 'addproduct', component: AddproductComponent, canActivate: [AuthGuard], data: { requiresAdmin: true }},
        { path: 'reset', component: ResetPasswordComponent },
        { path: 'adminpannel', component: AdminPannelComponent, canActivate: [AuthGuard], data: { requiresAdmin: true }},
